<?php if( have_posts() ) : while( have_posts() ): the_post();?>
    ...
    <h2 class="text-5xl mt-4 py-4 uppercase flex justify-center"><?php the_title();?></h2>
    <h3 class="text-md mt-2 py-2 sm:px-12 text-gray-600 tracking-wider flex justify-center"> <?php the_excerpt();?></h3>
   ...
   <div class="image-post"><?php echo get_the_post_thumbnail( get_the_ID() );?></div>
    ...
    <div class="w-full h-full mt-px sm:mt-8 py-2 flex border-b boder-red-900">
        ...
        <div class="w-full h-auto sm:mt-4 py-2 sm:flex sm:justify-center">
            <div class="w-full sm:w-1/3 flex jsutify-start smjustify-center items-end">
            ...
            <span class="hidden w-1/3 sm:flex flex-row justify-start items-end">
            ...
            <div class="w-full sm:w-1/3 flex mt-6 sm:mt-0 justify-end items-end">
    ...
    <div class="stricto-content flex flex-col space-y-2 py-2 sm:px-6 mt-2 sm:mt-4 mb-24">
