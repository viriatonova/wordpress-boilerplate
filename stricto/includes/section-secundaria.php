        ...
        <article class="w-full h-auto py-6">
            ...
            <div class="flex flex-col xl:flex-row mt-4">
                ...
                <?php if( have_posts() ) : while( have_posts() ): the_post();?>
                    ...
                    <div class="w-full h-full flex flex-col xl:flex-row mt-4 sm:mt-0 px-2" id="artigo_capa">
                        <a class="" href="<?php the_permalink();?>">
                            <?php echo get_the_post_thumbnail( get_the_ID(), 'stricto-small' );?>
                        </a>
                        <div class="w-full xl:w-1/2 h-full xl:ml-4 xl:px-4 mt-6 xl:mt-0">
        ...
        <article class="w-full h-full mt-2 mx-2 py-4 border-t border-light-gray-900 ">
            ...
            <div class="flex mt-4">
                <div class="w-full flex flex-col xl:flex-row">
					...
					<div class="w-full px-2 flex flex-col xl:flex-row">
						<a id="arte-image" href="<?php the_permalink();?>">
							<?php echo get_the_post_thumbnail( get_the_ID(), 'stricto-small' );?>
						</a>
						<div class="w-full xl:w-1/2 flex flex-col xl:ml-4 xl:px-4 mt-6 xl:mt-0 items-start">
