<footer class="w-full h-32 text-gray-600 body-font mt-6 bg-white">
    ...
    <section class="px-2 py-4 mx-auto flex items-center sm:flex-row flex-col border-b border-gray-900">
        ...
        <span class="ml-3 text-xl">Stricto Digital</span>
    ...
    <div class="px-2 py-2 mt-2 sm:mt-4 mx-auto hidden sm:flex items-start sm:flex-row flex-col ">
        ...
        <section class="w-2/3 flex flex-col justify-start items-start">
            <div class="w-full px-2 flex ">
                <div class="w-full flex flex-col justify-start px-2">
                    <h3 class="w-full text-xl capitalize tracking-wide text-purple-900">apoie o jornalismo independente</h3>
                    <p class="w-full text-sm tracking-wider leading-6 py-6">
                        O stricto é um meio de comunicação independete, para continuar fazendo o trabalho
                        ...
                        acesse o QR-code abaixo é use o PIX para constribuir. 
                    </p>
                </div>
        ...
        <aside class="stricto-footer-aside w-1/3 h-full flex flex-col justify-end items-start px-4">

            <h3 class="text-lg capitalize tracking-wide text-purple-900">Navegação do Site</h3>
            ...
            <div class="flex flex-col mt-6">
                    <h4 class="text-lg capitalize tracking-wide text-purple-900">Contato</h4>
                    <h5 class="text-xs sm:text-sm mt-4">Contate nossa redação</h5>
                    <a class=" mt-px" href="mailto:jornalismo@strictodigital.com.br"><p class="text-purple-900 tracking-wide text-xs sm:text-sm sm:text-md">jornalismo@strictodigital</p></a>
                </div>
